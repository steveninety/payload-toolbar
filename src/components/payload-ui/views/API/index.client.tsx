...
import { LocaleSelector } from '@payloadcms/next/views/API/LocaleSelector'
import { RenderJSON } from '@payloadcms/next/views/API/RenderJSON'
import Toolbar from '@/components/Toolbar'

const baseClass = 'query-inspector'

export const APIViewClient: React.FC<{ documentTabs: React.ReactNode }> = ({ documentTabs }) => {
