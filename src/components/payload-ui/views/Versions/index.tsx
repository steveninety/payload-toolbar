...
import { fetchLatestVersion, fetchVersions } from '@payloadcms/next/views/Version/fetchVersions'
import { VersionDrawerCreatedAtCell } from '@payloadcms/next/views/Version/SelectComparison/VersionDrawer/CreatedAtCell'
import { buildVersionColumns } from '@payloadcms/next/views/Versions/buildColumns'
import { VersionsViewClient } from '@payloadcms/next/views/Versions/index.client'
import './index.scss'
...
export async function VersionsView(
  props: DocumentViewServerProps & { documentTabs: React.ReactNode },
) {
  const {
    hasPublishedDoc,
    initPageResult: {
  ...
  return (
    <React.Fragment>
      ...
      <main className={baseClass}>
        <Toolbar documentTabs={documentTabs}></Toolbar>
